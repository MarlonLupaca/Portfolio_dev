        ...
        <div id='home' className='h-[100vh] flex justify-center'>
            <section className='  mt-[20px] md:mt-[50px] md:w-[1100px] flex flex-col-reverse md:flex-row md:justify-between justify-center items-center'>
                <div className=' md:w-[550px] w-full md:p-0 px-10'>
                    <h1 className=' font-[800] text-[38px] md:text-[60px]'>Hola, soy <span className='text-principal'>Marlon</span></h1>
                    <div className='  relative mt-[15px] h-[28px] md:h-[45px] overflow-hidden md:mt-[2px]'>
                        <div className=' text-[18px] md:text-[30px] absolute animate-desplazamiento_movil md:animate-desplazamiento_destok'>
                    ...
                    <div className=' md:text-[14px]  text-[13px] w-full md:w-[400px] flex md:justify-evenly mt-[20px] md:gap-0 gap-4'>
                ...
                <img src={ fotoSinFondo } alt="Foto del dev" className='md:mb-0 mb-14 shadow-custom-green bg-custom-rgba transition duration-300 ease-in-out h-[250px] md:h-[400px] rounded-full md:mr-[50px] hover:scale-[1.02]' />
            </section>
        </div>
    )
}

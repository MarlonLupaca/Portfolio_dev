            ...
            <section className='  mt-[20px] md:mt-[50px] md:w-[1100px] flex flex-col-reverse md:flex-row md:justify-between justify-center items-center'>
                <div className='  md:w-[550px] w-full md:p-0 px-8'>
                    <div className='mx-auto w-[290px] md:w-full'>
                        <h1 className=' w-fit font-[800] text-[35px] ms:text-[38px] md:text-[60px]'>Hola, soy <span className='text-principal'>Marlon</span></h1>
                        ...
                        <p className=' mt-[15px] text-[18px] md:text-[20px] md:w-[450px]' >De <span className='text-[#FF69B4]'>Arequipa, Perú. </span>Especialista en desarrollar <span className='text-[#d8b137]'>aplicaciones desde cero.</span></p>

const dataSistemaDeInventarios = {
  ...
  Descripcion:
    'Este proyecto es una aplicación web de escritorio, desarrollada con JavaScript, HTML y CSS vanilla, diseñada para gestionar inventarios de manera eficiente. La página permite a los usuarios registrar, editar y eliminar productos, así como visualizar el stock disponible. El diseño limpio y la lógica implementada aseguran un buen rendimiento en la gestión de datos de inventario.',
  Vistas: {
    github: true,
    preview: true,
  },
...
const DataEcommerce = {
  ...
  Tecnologias: ['NextJS', 'TailwindCSS', 'Spring Boot', 'React'],
  Descripcion:
    'Proyecto eCommerce FullStack con Next.js + React + Tailwind (frontend modular), backend en Spring Boot microservicios, comunicación WebSocket (chat en tiempo real), autenticación JWT, consumo de APIs con Axios, despliegue en Docker, y arquitectura desacoplada (Admin/Cliente).',
  Vistas: {
    github: true,
    preview: false,
  },
  url: {
    github: 'https://github.com/MarlonLupaca/FullStack',
    preview: '#',
